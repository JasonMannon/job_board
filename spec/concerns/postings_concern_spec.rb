...
RSpec.describe PostingsConcern do
  context '#grouped_postings' do
    let!(:programming_posting_1) { create(:posting, :programming) }
    let!(:programmign_posting_2) { create(:posting, :programming) }
    let!(:marketing_posting) { create(:posting, :marketing) }
